...
if not BOT_TOKEN:
    logger.error("❌ BOT_TOKEN non défini dans les variables d'environnement!")
    sys.exit(1)
...
║  💰 Système financier               ║
║  🔫 Braquages (1-6 joueurs)         ║
║  🕵️ Vols (15% réussite)            ║
║  🏇 Courses de chevaux              ║
║  🎰 Casino (Roulette, Slots, Dés)  ║
║  🏆 Classement                      ║
║  ❌ Annulation braquage/course      ║
╚══════════════════════════════════════╝
        """)
        # Démarrer le bot
        logger.info("✅ Bot démarré!")
        
        # Configuration pour Render (pas de webhook, juste polling)
